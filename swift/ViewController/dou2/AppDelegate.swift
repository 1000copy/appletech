...
class Page1: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button1.setTitle("Test Button", for: UIControlState())
        ...
        button4.frame = CGRect(x: 100, y: 300, width: 100, height: 50)
        button4.backgroundColor = UIColor.blue
        button4.setTitle("Button4", for: UIControlState())
        button4.addTarget(self, action: #selector(Page1.buttonAction4(_:)), for: UIControlEvents.touchUpInside)
        view.addSubview(button4)
        let button5   = UIButton(type: UIButtonType.system) as UIButton
        button5.frame = CGRect(x: 100, y: 350, width: 100, height: 50)
        button5.backgroundColor = UIColor.blue
        button5.setTitle("Button5", for: UIControlState())
        button5.addTarget(self, action: #selector(Page1.buttonAction5(_:)), for: UIControlEvents.touchUpInside)
        view.addSubview(button5)
        let button6   = UIButton(type: UIButtonType.system) as UIButton
        button6.frame = CGRect(x: 100, y: 400, width: 100, height: 50)
        button6.backgroundColor = UIColor.blue
        button6.setTitle("Button6", for: UIControlState())
        button6.addTarget(self, action: #selector(Page1.buttonAction6(_:)), for: UIControlEvents.touchUpInside)
